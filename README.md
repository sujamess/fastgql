...
[fastgql](https://github.com/sujamess/fastgql) This fork adds [fasthttp](https://github.com/valyala/fasthttp) support to the latest version of [gqlgen](https://github.com/99designs/gqlgen).<br/>
...
If you can't find what your looking for, look at our [examples](https://github.com/sujamess/fastgql/tree/master/example) for example usage of gqlgen, or visit [godoc](https://godoc.org/github.com/99designs/gqlgen).

Don't forget to replace `go run github.com/99designs/gqlgen` with `go run github.com/sujamess/fastgql` when you are using doc commands!
...
You can see these [examples](https://github.com/sujamess/fastgql/tree/master/example) here or visit [godoc](https://godoc.org/github.com/99designs/gqlgen).
