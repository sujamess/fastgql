...
func (ec *executionContext) _Chatroom_messages(ctx context.Context, field graphql.CollectedField, obj *Chatroom) (ret graphql.Marshaler) {
	...
	res := resTmp.([]Message)
	fc.Result = res
	return ec.marshalNMessage2ᚕgithubᚗcomᚋarsmnᚋfastgqlᚋexampleᚋchatᚐMessageᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_post(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Message)
	fc.Result = res
	return ec.marshalNMessage2ᚖgithubᚗcomᚋarsmnᚋfastgqlᚋexampleᚋchatᚐMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_room(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Chatroom)
	fc.Result = res
	return ec.marshalOChatroom2ᚖgithubᚗcomᚋarsmnᚋfastgqlᚋexampleᚋchatᚐChatroom(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Subscription_messageAdded(ctx context.Context, field graphql.CollectedField) (ret func() graphql.Marshaler) {
	...
	return func() graphql.Marshaler {
		...
		return graphql.WriterFunc(func(w io.Writer) {
			...
			w.Write([]byte{':'})
			ec.marshalNMessage2ᚖgithubᚗcomᚋarsmnᚋfastgqlᚋexampleᚋchatᚐMessage(ctx, field.Selections, res).MarshalGQL(w)
			w.Write([]byte{'}'})
		})
	}
}
...
func (ec *executionContext) marshalNMessage2githubᚗcomᚋarsmnᚋfastgqlᚋexampleᚋchatᚐMessage(ctx context.Context, sel ast.SelectionSet, v Message) graphql.Marshaler {
	return ec._Message(ctx, sel, &v)
}

func (ec *executionContext) marshalNMessage2ᚕgithubᚗcomᚋarsmnᚋfastgqlᚋexampleᚋchatᚐMessageᚄ(ctx context.Context, sel ast.SelectionSet, v []Message) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMessage2githubᚗcomᚋarsmnᚋfastgqlᚋexampleᚋchatᚐMessage(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMessage2ᚖgithubᚗcomᚋarsmnᚋfastgqlᚋexampleᚋchatᚐMessage(ctx context.Context, sel ast.SelectionSet, v *Message) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOChatroom2ᚖgithubᚗcomᚋarsmnᚋfastgqlᚋexampleᚋchatᚐChatroom(ctx context.Context, sel ast.SelectionSet, v *Chatroom) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
