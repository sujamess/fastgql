...
func (ec *executionContext) field_Query_directiveInputType_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["arg"]; ok {
		...
		if data, ok := tmp.(InnerInput); ok {
			...
			return nil, graphql.ErrorOnPath(ctx, fmt.Errorf(`unexpected type %T from directive, should be github.com/arsmn/fastgql/codegen/testserver.InnerInput`, tmp))
		}
	}
	args["arg"] = arg0
	return args, nil
...
func (ec *executionContext) _Query_directiveObject(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/arsmn/fastgql/codegen/testserver.ObjectDirectives`, tmp)
	})
...
func (ec *executionContext) _Query_noShape(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/arsmn/fastgql/codegen/testserver.Shape`, tmp)
	})
...
func (ec *executionContext) _Query_animal(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/arsmn/fastgql/codegen/testserver.Animal`, tmp)
	})
	...
	for k, v := range asMap {
		...
		case "thirdParty":
			...
			if data, ok := tmp.(*ThirdParty); ok {
				...
				err := fmt.Errorf(`unexpected type %T from directive, should be *github.com/arsmn/fastgql/codegen/testserver.ThirdParty`, tmp)
				return it, graphql.ErrorOnPath(ctx, err)
			}
		}
	}
